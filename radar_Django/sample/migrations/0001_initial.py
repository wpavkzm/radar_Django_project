    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('motion_detection', models.CharField(db_column='Motion_Detection', max_length=45)),
                ('detect_interval', models.CharField(db_column='Detect_Interval', max_length=45)),
                ('detect_distance', models.CharField(db_column='Detect_Distance', max_length=45)),
