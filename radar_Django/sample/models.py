...
class RadarSensor(models.Model):
    ...
    motion_detection = models.CharField(
        db_column='Motion_Detection', max_length=45)
    # Field name made lowercase.
    detect_interval = models.CharField(
        db_column='Detect_Interval', max_length=45)
    # Field name made lowercase.
    detect_distance = models.CharField(
        db_column='Detect_Distance', max_length=45)
    push_time = models.DateTimeField()
    radar_rssi = models.CharField(max_length=45)
